...
rem Created by (eXtreme+ Support Crew) Editted by {LFNY} Crash
rem
...
set XDIR_TOOLS=F:\My Ghost Images\Activision Server\Call of Duty 4 - Modern Warfare
rem ------------------------------------------------------------------
...
echo Created by PatmanSan (eXtreme+ Support Crew) Editted by {LFNY} Crash
